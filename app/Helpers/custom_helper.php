...
if (! function_exists('envparam')) {
    ...
    function getSingleSheetXlsxFile($details,$file,$date){
        //Give our xlsx file a name.
        $xlsxFileName = $file.'_'.$date.'.xlsx';
                                ...
                                if(isEmptyArray($row_data)){
                                    ...
                                    foreach($row_data as $cell_key => $cell_value)
                                    {
                                        if($cell_key == '5'){
                                            ...
                                            $insert_data['booking_date'] = (!empty($cell_value))?"'".ltrim(trim($cell_value," "),'£')."'":NULL;
                                        }elseif($cell_key == '11'){
                                            $insert_data['delivery_date'] = (!empty($cell_value))?"'".$cell_value."'":NULL;
                                        }
                                        //elseif($cell_key == '12'){
    ...
    function importExcelByNewLib($file_path){
