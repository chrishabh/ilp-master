...
class ConstructionDetails extends Model
{
    ...
    public static function getDescriptionWorkMobile($request)
    {
        ...
        if(count($apartment_id)>0){
            $data = ConstructionDetails::join('user_project_linkings','user_project_linkings.main_description_id','=','construction_details.main_description_id')->join('user_project_linkings','user_project_linkings.sub_description_id','=','construction_details.sub_description_id')->join('main_descritpions', 'main_descritpions.id', '=', 'construction_details.main_description_id')
