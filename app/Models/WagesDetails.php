...
class WagesDetails extends Model
{
    ...
    public static function getWagesReportGroupBy($request)
    {
        ...
        'project_details.project_name','block_details.block_name','wages_details.apartment_id'
        ,'apartment_details.apartment_number','main_descritpions.description','sub_descritpions.sub_description','floors.floor_name','wages_details.created_at','wages_details.delivery_date','wages_details.unit','wages_details.description')->get();
